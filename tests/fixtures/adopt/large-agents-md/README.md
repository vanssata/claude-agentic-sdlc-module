# Large AGENTS.md fixture

Source: this plugin's own scaffold (`hooks/project-scaffold.sh`, `skills/ai-init/scaffold-ai.sh --runtime codex`) and `instructions/runtimes.json` `_budgets.skeleton` (2048 B).
Checked: 2026-09-22

`fixture-AGENTS.md` (47 lines, 2121 B of project notes) is appended to the scaffolded AGENTS.md, which
